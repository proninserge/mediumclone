...
export const mutationTypes = {
  getPopularTagsStart: '[popularTags] PopularTagsStart',
  getPopularTagsSuccess: '[popularTags] PopularTagsSuccess',
  getPopularTagsFailure: '[popularTags] PopularTagsFailure',
};
