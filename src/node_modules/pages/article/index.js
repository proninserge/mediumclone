...
const Article = () => {
  const slug = useLocation().pathname.replace('/articles/', '')
  ...
  const [isSuccessfullDelete, setIsSuccessfullDelete] = React.useState(false)
  ...
  return (
    <div className="article-page">
      ...
      <div className="container page">
        ...
        {(fetchArticleError ||
          (fetchArticleResponse && !fetchArticleResponse.article.title)) && (
          <ErrorMessage />
        )}
